...
//        Debug.Log("planeAnchor " + planeAnchor);
...
//        Debug.Log("inversedNormal " + inversedNormal);
//        Debug.Log("inversedAnchor " + inversedAnchor);
...
//        Debug.Log("subMesh " + originalMesh.subMeshCount);
...
//        Debug.Log("triangleCache.vertices[1] " + triangleCache.vertices[1]);
//        Debug.Log("triangleCache.vertices[0] " + triangleCache.vertices[0]);
//        Debug.Log("newTriangleCache.vertices[0] " + Vector3.Lerp(triangleCache.vertices[0], triangleCache.vertices[1], normalizedDistance));
...
//    {
//        Debug.Log("triangleCache.vertices[1] - triangleCache.vertices[0]) " + (triangleCache.vertices[1] - triangleCache.vertices[0]));
//        Debug.Log("triangleCache.vertices[2] - triangleCache.vertices[0]) " + (triangleCache.vertices[2] - triangleCache.vertices[0]));
...
//        Debug.Log("triangleCache.normals[0] " + triangleCache.normals[0]);
//        Debug.Log("triangleCache.normals[1] " + triangleCache.normals[1]);
//        Debug.Log("triangleCache.normals[2] " + triangleCache.normals[2]);
